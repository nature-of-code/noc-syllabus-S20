...
* [Introduction to Machine Learning slides](). These slides are from @joeyklee's [friendly introduction to machine learning and ml5.js - workshop](https://github.com/ml5js/ml5-friendly-intro-to-ml-2019f#introduction-to-machine-learning) and also based off of @yining1023's [Machine Learning for the Web](https://github.com/yining1023/machine-learning-for-the-web)
